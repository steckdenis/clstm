...
struct CLSTMText {
    ...
    Sequence targets;
    Sequence aligned;
    void setLearningRate(float lr, float mom) {
        net->setLearningRate(lr, mom);
    }
    ...
    void createBidi(const std::vector<int> &icodec, const std::vector<int> codec, int nhidden) {
